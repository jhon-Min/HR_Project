...
(function ($, window, document, undefined) {
  ...
  var defaults = {
    ...
    inputmode: "numeric",
    inputclass: "",
    // add custom class to input tag
    containerclass: "",
    // add custom class to container block
    errorclass: "text-danger",
    // add custom class to error block
    characterwidth: null,
  ...
  $.extend(Plugin.prototype, {
    ...
    _addEventsToInput: function _addEventsToInput(input, inputnumber) {
      ...
      }, this)); // paste event should call onchange and oncomplete callbacks
      ...
      input.on("keyup", $.proxy(function (e) {
        ...
        this.updateOriginalInput(); // onchange event for each input
...
try {
  ...
  window.QrScanner = __webpack_require__(/*! qr-scanner/qr-scanner.umd.min.js */ "./node_modules/qr-scanner/qr-scanner.umd.min.js"); // if installed via package

  window.Swal = sweetalert2_dist_sweetalert2_js__WEBPACK_IMPORTED_MODULE_0___default.a; // require('bootstrap');
} catch (e) {}
/**
...
__webpack_require__(/*! /home/seo/Desktop/new-development/laravel-pjs/lara-hr/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/seo/Desktop/new-development/laravel-pjs/lara-hr/resources/sass/app.scss */"./resources/sass/app.scss");
